...
<div class="container py-4">
    ...
    <form action="{{ route('admin.scholarships.update', $item) }}" method="POST" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="criteria" class="form-control">{{ old('criteria', $item->criteria) }}</textarea>
        </div>
