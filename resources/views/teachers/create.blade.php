...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="page-header-title mb-1">Add Faculty Member</h3>
            <p class="text-muted small mb-0">Create new teacher profile, credentials, and class leadership assignments.</p>
        </div>
            ...
            <div class="col-lg-6">
                <div class="card custom-card h-100">
                    <div class="card-header">
                        <h5 class="card-title mb-0"><i class="bi bi-person-fill me-2 text-danger"></i>Account & Personal Details</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label required fw-semibold">Faculty Name</label>
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="e.g. Dr. Robert Langdon">
                        </div>

                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <label class="form-label required fw-semibold">Email Address</label>
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required placeholder="teacher@school.com">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label required fw-semibold">Password</label>
                                <input type="password" name="password" class="form-control" required placeholder="Minimum 6 chars" value="password">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="emergency_contact" class="form-control" value="{{ old('emergency_contact') }}" placeholder="+1-555-9999">
                            </div>
                        </div>
                ...
                <div class="card custom-card h-100">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="employee_id" class="form-control @error('employee_id') is-invalid @enderror" value="{{ old('employee_id') }}" required placeholder="e.g. EMP-003">
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold">Highest Qualification</label>
                            <input type="text" name="qualification" class="form-control" value="{{ old('qualification') }}" placeholder="e.g. Ph.D. in Mathematics">
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold">Specialization / Subjects</label>
                            <input type="text" name="specialization" class="form-control" value="{{ old('specialization') }}" placeholder="e.g. Advanced Calculus, Linear Algebra">
                        </div>
                        ...
                        <div class="border-top pt-3 mt-3">
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" name="is_class_teacher" value="1" id="isClassTeacher" {{ old('is_class_teacher') ? 'checked' : '' }}>
                                <label class="form-check-label fw-semibold" for="isClassTeacher">Designate as Class Teacher</label>
                            </div>

                            <div class="mb-3" id="classTeacherSelectGroup">
